...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "FinanzasApp.Presentacion.dll" comes first in this list. */
		"FinanzasApp.Presentacion.dll",
		...
		"FinanzasApp.Aplicacion.dll",
		"FinanzasApp.Domain.dll",
		"FinanzasApp.Infraestructura.dll",
